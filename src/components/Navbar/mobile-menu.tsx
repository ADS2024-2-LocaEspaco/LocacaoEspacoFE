...
export default function MobileMenu() {
    ...
    return (
        <>
            ...
            <div className='flex flex-col jus bg-white absolute h-screen w-full md:hidden p-4 gap-6'>
                ...
                <button className="mx-auto bg-blue-300 text-white font-bold hover:opacity-90 px-8 py-2 rounded-2xl">Pesquisar</button>
            </div>
        </>
    )
}