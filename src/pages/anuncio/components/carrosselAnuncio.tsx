...
const Carrossel: React.FC<CarrosselProps> = ({ imagens }) => {
  ...
  return (
    <div className="relative flex items-center justify-center w-[95%] border border-gray-400 pb-[16px] md:w-[80%] rounded-lg shadow-[0_4px_24px_-1px_rgba(0,0,0,0.25)]">
      <div
      ...
      >
        {
          <img
            src={setaEsquerda}
            alt="botão de navegação do carrossel, esquerda"
          />
        }
      </button>
      ...
      >
        {
          <img
            src={setaDireita}
            alt="botão de navegação do carrossel, direita"
          />
        }
      </button>
    </div>
