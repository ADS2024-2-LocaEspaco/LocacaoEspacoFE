            ...
            <main className="flex flex-col justify-center ml-20 mr-20">
                ...
                <div className="relative flex items-center">
                    <input
                        ...
                        readOnly={!isEditing}
                        className={`h-8 text-center border border-solid border-black rounded-xl mt-2 
                            placeholder:items-center bg-gray-100 dark:border-white dark:bg-custom-gray-2 
                            dark:text-white pr-8 ${isEditing ? 'pl-8' : ''}`}
                    /> 
                    {isEditing && (
                ...
                <label className="mt-4 text-base font-medium dark:text-white">Média de avaliação</label>
